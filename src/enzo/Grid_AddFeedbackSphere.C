...
//	    ramp = min(max(1.0 - (r1 - 0.8)/0.4, 0.01), 1.0);
	    ...
	    if (MultiSpecies > 1) {
	      ...
	      BaryonField[H2IINum][index] *= increase;
              BaryonField[CINum][index] *= increase;
       	      BaryonField[CIINum][index] *= increase;
       	      BaryonField[OINum][index] *= increase;
       	      BaryonField[OIINum][index] *= increase;
       	      BaryonField[CHINum][index] *= increase;
       	      BaryonField[CH2INum][index] *= increase;
       	      BaryonField[COINum][index] *= increase;
       	      BaryonField[OHINum][index] *= increase;
       	      BaryonField[H2OINum][index] *= increase;
       	      BaryonField[O2INum][index] *= increase;
       	      BaryonField[COIINum][index] *= increase;
       	      BaryonField[O2IINum][index] *= increase;
       	      BaryonField[OHIINum][index] *= increase;
       	      BaryonField[H2OIINum][index] *= increase;
       	      BaryonField[H3OIINum][index] *= increase;
       	      BaryonField[CH3INum][index] *= increase;
       	      BaryonField[CH4INum][index] *= increase;
       	      BaryonField[CO2INum][index] *= increase;
