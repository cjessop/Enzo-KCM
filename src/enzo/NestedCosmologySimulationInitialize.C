			       		...
			       		HierarchyEntry &TopGrid, TopGridData &MetaData)
{
  ...
  while (fgets(line, MAX_LINE_LENGTH, fptr) != NULL) {
    ...
    ret += sscanf(line, "CosmologySimulationInitialFractionCI = %"FSYM,
                  &CosmologySimulationInitialFractionCI);
    ret += sscanf(line, "CosmologySimulationInitialFractionCII = %"FSYM,
                  &CosmologySimulationInitialFractionCII);
    ret += sscanf(line, "CosmologySimulationInitialFractionOI = %"FSYM,
                  &CosmologySimulationInitialFractionOI);
    ret += sscanf(line, "CosmologySimulationInitialFractionOII = %"FSYM,
                  &CosmologySimulationInitialFractionOII);
    ret += sscanf(line, "CosmologySimulationInitialFractionCHI = %"FSYM,
                  &CosmologySimulationInitialFractionCHI);
    ret += sscanf(line, "CosmologySimulationInitialFractionCH2I = %"FSYM,
                  &CosmologySimulationInitialFractionCH2I);
    ret += sscanf(line, "CosmologySimulationInitialFractionCOI = %"FSYM,
                  &CosmologySimulationInitialFractionCOI);
    ret += sscanf(line, "CosmologySimulationInitialFractionOHI = %"FSYM,
                  &CosmologySimulationInitialFractionOHI);
    ret += sscanf(line, "CosmologySimulationInitialFractionH2OI = %"FSYM,
                  &CosmologySimulationInitialFractionH2OI);
    ret += sscanf(line, "CosmologySimulationInitialFractionO2I = %"FSYM,
                  &CosmologySimulationInitialFractionO2I);
    ret += sscanf(line, "CosmologySimulationInitialFractionCOII = %"FSYM,
                  &CosmologySimulationInitialFractionCOII);
    ret += sscanf(line, "CosmologySimulationInitialFractionO2II = %"FSYM,
                  &CosmologySimulationInitialFractionO2II);
    ret += sscanf(line, "CosmologySimulationInitialFractionOHII = %"FSYM,
                  &CosmologySimulationInitialFractionOHII);
    ret += sscanf(line, "CosmologySimulationInitialFractionH2OII = %"FSYM,
                  &CosmologySimulationInitialFractionH2OII);
    ret += sscanf(line, "CosmologySimulationInitialFractionH3OII = %"FSYM,
                  &CosmologySimulationInitialFractionH3OII);
    ret += sscanf(line, "CosmologySimulationInitialFractionCH3I = %"FSYM,
                  &CosmologySimulationInitialFractionCH3I);
    ret += sscanf(line, "CosmologySimulationInitialFractionCH4I = %"FSYM,
                  &CosmologySimulationInitialFractionCH4I);
    ret += sscanf(line, "CosmologySimulationInitialFractionCO2I = %"FSYM,
                  &CosmologySimulationInitialFractionCO2I);
...
//}
  ...
  if (MyProcessorNumber == ROOT_PROCESSOR) {
    ...
    fprintf(Outfptr, "CosmologySimulationInitialFractionH2II  = %"GSYM"\n",
	    CosmologySimulationInitialFractionH2II);
     fprintf(Outfptr, "CosmologySimulationInitialFractionCI  = %"GSYM"\n",
            CosmologySimulationInitialFractionCI);
    fprintf(Outfptr, "CosmologySimulationInitialFractionCII  = %"GSYM"\n",
            CosmologySimulationInitialFractionCII);
    fprintf(Outfptr, "CosmologySimulationInitialFractionOI  = %"GSYM"\n",
            CosmologySimulationInitialFractionOI);
    fprintf(Outfptr, "CosmologySimulationInitialFractionOII  = %"GSYM"\n",
            CosmologySimulationInitialFractionOII);
    fprintf(Outfptr, "CosmologySimulationInitialFractionCHI  = %"GSYM"\n",
            CosmologySimulationInitialFractionCHI);
    fprintf(Outfptr, "CosmologySimulationInitialFractionCH2I  = %"GSYM"\n",
            CosmologySimulationInitialFractionCH2I);
    fprintf(Outfptr, "CosmologySimulationInitialFractionCOI  = %"GSYM"\n",
            CosmologySimulationInitialFractionCOI);
    fprintf(Outfptr, "CosmologySimulationInitialFractionOHI  = %"GSYM"\n",
            CosmologySimulationInitialFractionOHI);
    fprintf(Outfptr, "CosmologySimulationInitialFractionH2OI  = %"GSYM"\n",
            CosmologySimulationInitialFractionH2OI);
    fprintf(Outfptr, "CosmologySimulationInitialFractionO2I  = %"GSYM"\n",
            CosmologySimulationInitialFractionO2I);
    fprintf(Outfptr, "CosmologySimulationInitialFractionCOII  = %"GSYM"\n",
            CosmologySimulationInitialFractionCOII);
    fprintf(Outfptr, "CosmologySimulationInitialFractionO2II  = %"GSYM"\n",
            CosmologySimulationInitialFractionO2II);
    fprintf(Outfptr, "CosmologySimulationInitialFractionOHII  = %"GSYM"\n",
            CosmologySimulationInitialFractionOHII);
    fprintf(Outfptr, "CosmologySimulationInitialFractionH2OII  = %"GSYM"\n",
            CosmologySimulationInitialFractionH2OII);
    fprintf(Outfptr, "CosmologySimulationInitialFractionH3OII  = %"GSYM"\n",
            CosmologySimulationInitialFractionH3OII);
    fprintf(Outfptr, "CosmologySimulationInitialFractionCH3I  = %"GSYM"\n",
            CosmologySimulationInitialFractionCH3I);
    fprintf(Outfptr, "CosmologySimulationInitialFractionCH4I  = %"GSYM"\n",
            CosmologySimulationInitialFractionCH4I);
    fprintf(Outfptr, "CosmologySimulationInitialFractionCO2I  = %"GSYM"\n",
            CosmologySimulationInitialFractionCO2I);
