				...
				float UniformBField[])
{
  ...
  int COIINum, O2IINum, OHIINum, H2OIINum, H3OIINum, CH3INum, CH4INum, CO2INum;
  ...
  if (TestProblemData.KCM) {
    ...
    tg->FieldType[COIINum = tg->NumberOfBaryonFields++] = COIIDensity;
    tg->FieldType[O2IINum = tg->NumberOfBaryonFields++] = O2IIDensity;
    tg->FieldType[OHIINum = tg->NumberOfBaryonFields++] = OHIIDensity;
    tg->FieldType[H2OIINum = tg->NumberOfBaryonFields++] = H2OIIDensity;
    tg->FieldType[H3OIINum = tg->NumberOfBaryonFields++] = H3OIIDensity;
    tg->FieldType[CH3INum = tg->NumberOfBaryonFields++] = CH3IDensity;
    tg->FieldType[CH4INum = tg->NumberOfBaryonFields++] = CH4IDensity;
    tg->FieldType[CO2INum = tg->NumberOfBaryonFields++] = CO2IDensity;
}
