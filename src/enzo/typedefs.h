...
/* these are required for Simon Glover's chemistry (which also needs some of the
  ...
  H2OIDensity     = 80,
  O2IDensity      = 81,
 /* Additional fields from Omukai 2005 */
  COIIDensity     = 82,
  O2IIDensity     = 83,
  OHIIDensity     = 84,
  H2OIIDensity    = 85,
...
/* FLD radiation module stuff (D. Reynolds) */ 
  ...
  MetalSNIaDensity = 108,
  MetalSNIIDensity = 109,
...
enum field_type {Density, TotalEnergy, InternalEnergy, Pressure,
		 ...
		 H2IIDensity, DIDensity, DIIDensity, HDIDensity,
                 CIDensity, CIIDensity, OIDensity, OIIDensity,
                 CHIDensity, CH2IDensity, COIDensity, OHIDensity,
                 COIDensity, H2OIDensity, O2IIDensity, OHIIDensity, 
                 H2OIIDensity, H3OIIDensity, CH3IDensity, CH4IDensity, 
                 CO2IDensity,
