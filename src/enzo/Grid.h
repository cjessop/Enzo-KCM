...
/  modified1:  Chris Jessop, August 2020
/ 
/  PURPOSE:
/
************************************************************************/
...
//
   ...
   float* AccessCIDensity();
   float* AccessCIIDensity();
   float* AccessOIDensity();
   float* AccessOIIDensity();
   float* AccessCHIDensity();
   float* AccessCH2IDensity();
   float* AccessCOIDensity();
   float* AccessOHIDensity();
   float* AccessH2OIDensity();
   float* AccessO2IDensity();
   float* AccessCOIIDensity();
   float* AccessO2IIDensity();
   float* AccessOHIIDensity();
   float* AccessH2OIIDensity();
   float* AccessH3OIIDensity();
   float* AccessCH3IDensity();
   float* AccessCH4IDensity();
   float* AccessCO2IDensity();
...
/* Baryons: find certain commonly used variables from the list of fields. */
  ...
  int IdentifySpeciesFieldsKrome(int &DeNum, int &HMNum, int &HINum, int &HeINum,
...
/* Cluster: initialize grid. */
  ...
  int CosmologySimulationInitializeGrid(
			  ...
			  float CosmologySimulationInitialFractionH2II,
                          float CosmologySimulationInitialFractionCI,
                          float CosmologySimulationInitialFractionCII,
                          float CosmologySimulationInitialFractionOI,
                          float CosmologySimulationInitialFractionOII,
                          float CosmologySimulationInitialFractionCHI,
                          float CosmologySimulationInitialFractionCH2I,
                          float CosmologySimulationInitialFractionCOI,
                          float CosmologySimulationInitialFractionOHI,
                          float CosmologySimulationInitialFractionH2OI,
                          float CosmologySimulationInitialFractionO2I,
                          float CosmologySimulationInitialFractionCOII,
                          float CosmologySimulationInitialFractionO2II,
                          float CosmologySimulationInitialFractionOHII,
                          float CosmologySimulationInitialFractionH2OII,
                          float CosmologySimulationInitialFractionH3OII,
                          float CosmologySimulationInitialFractionCH3I,
                          float CosmologySimulationInitialFractionCH4I,
                          float CosmologySimulationInitialFractionCO2I,
