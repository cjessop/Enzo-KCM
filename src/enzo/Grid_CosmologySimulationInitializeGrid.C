...
/  modified4:  Chris Jessop, November 2020
/
/  PURPOSE:
/
			  ...
			  float CosmologySimulationInitialUniformBField[])
{
  ...
  int CINum, CIINum, OINum, OIINum, CHINum, CH2INum,
    COINum, OHINum, H2OINum, O2INum, COIINum, O2IINum;

  int OHIINum, H2OIINum, H3OIINum, CH3INum, CH4INum, CO2INum;
