...
int SetDefaultGlobalValues(TopGridData &MetaData)
{
  ...
  */
  ...
  TestProblemData.CarbonFractionByMass = 0.01;
  TestProblemData.OxygenFractionByMass = 0.01;
  TestProblemData.Oxygen2FractionByMass = 1.0e-20;
  TestProblemData.MethineFractionByMass = 1.0e-20;
  TestProblemData.Methine2FractionByMass = 1.0e-20;
  TestProblemData.Methine3FractionByMass = 1.0e-20;
  TestProblemData.Methine4FractionByMass = 1.0e-20;
  TestProblemData.CarbonMonoxideFractionByMass = 1.0e-20;
  TestProblemData.HydroxyFractionByMass = 1.0e-20;
  TestProblemData.WaterFractionByMass = 1.0e-20;
  TestProblemData.HydroniumFractionByMass = 1.0e-20;
  TestProblemData.CarbonDioxideFractionByMass = 1.0e-20;
  ...
  TestProblemData.KCM = 0;
  // Values for the Krome Chemistry Network in the surrounding medium
  ...
  TestProblemData.COII_Fraction = tiny_number;
  TestProblemData.O2II_Fraction = tiny_number;
  TestProblemData.OHII_Fraction = tiny_number;
  TestProblemData.H2OII_Fraction = tiny_number;
  TestProblemData.H3OII_Fraction = tiny_number;
  TestProblemData.CH3I_Fraction = tiny_number;
  TestProblemData.CH4I_Fraction = tiny_number;
  TestProblemData.CO2I_Fraction = tiny_number;

  // Values within ionised regions (SN blast radius) subject to change
  ...
  TestProblemData.COII_Fraction_Inner = tiny_number;
  TestProblemData.O2II_Fraction_Inner = tiny_number;
  TestProblemData.OHII_Fraction_Inner = tiny_number;
  TestProblemData.H2OII_Fraction_Inner = tiny_number;
  TestProblemData.H3OII_Fraction_Inner = tiny_number;
  TestProblemData.CH3I_Fraction_Inner = tiny_number;
  TestProblemData.CH4I_Fraction_Inner = tiny_number;
  TestProblemData.CO2I_Fraction_Inner = tiny_number;
