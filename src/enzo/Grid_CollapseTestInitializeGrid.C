...
static float CosmologySimulationInitialFractionCI    = 1.0e-20;
static float CosmologySimulationInitialFractionCII   = 1.0e-20;
static float CosmologySimulationInitialFractionOI    = 1.0e-20;
static float CosmologySimulationInitialFractionOII   = 1.0e-20;
static float CosmologySimulationInitialFractionCHI   = 1.0e-20;
static float CosmologySimulationInitialFractionCH2I  = 1.0e-20;
static float CosmologySimulationInitialFractionCOI   = 1.0e-20;
static float CosmologySimulationInitialFractionOHI   = 1.0e-20;
static float CosmologySimulationInitialFractionH2OI  = 1.0e-20;
static float CosmologySimulationInitialFractionO2I   = 1.0e-20;
static float CosmologySimulationInitialFractionCOII  = 1.0e-20;
static float CosmologySimulationInitialFractionO2II  = 1.0e-20;
static float CosmologySimulationInitialFractionOHII  = 1.0e-20;
static float CosmologySimulationInitialFractionH2OII = 1.0e-20;
static float CosmologySimulationInitialFractionH3OII = 1.0e-20;
static float CosmologySimulationInitialFractionCH3I  = 1.0e-20;
static float CosmologySimulationInitialFractionCH4I  = 1.0e-20;
static float CosmologySimulationInitialFractionCO2I  = 1.0e-20;
...
int grid::CollapseTestInitializeGrid(int NumberOfSpheres,
				     ...
				     float SphereH2I[MAX_SPHERES],
                                     float SphereCI[MAX_SPHERES],
                                     float SphereCII[MAX_SPHERES],
                                     float SphereOI[MAX_SPHERES],
                                     float SphereOII[MAX_SPHERES],
                                     float SphereCHI[MAX_SPHERES],
                                     float SphereCH2I[MAX_SPHERES],
                                     float SphereCOI[MAX_SPHERES],
                                     float SphereOHI[MAX_SPHERES],
                                     float SphereH2OI[MAX_SPHERES],
                                     float SphereO2I[MAX_SPHERES],
                                     float SphereCOII[MAX_SPHERES],
                                     float SphereO2II[MAX_SPHERES],
                                     float SphereOHII[MAX_SPHERES],
                                     float SphereH2OII[MAX_SPHERES],
                                     float SphereH3OII[MAX_SPHERES],
                                     float SphereCH3I[MAX_SPHERES],
                                     float SphereCH4I[MAX_SPHERES],
                                     float SphereCO2I[MAX_SPHERES],
				     ...
				     float CollapseTestInitialFractionH2II, 
                                     float CollapseTestInitialFractionCI,
                                     float CollapseTestInitialFractionCII,
                                     float CollapseTestInitialFractionOI,
                                     float CollapseTestInitialFractionOII,
                                     float CollapseTestInitialFractionCHI,
                                     float CollapseTestInitialFractionCH2I,
                                     float CollapseTestInitialFractionCOI,
                                     float CollapseTestInitialFractionOHI,
                                     float CollapseTestInitialFractionH2OI,
                                     float CollapseTestInitialFractionO2I,
                                     float CollapseTestInitialFractionCOII,
                                     float CollapseTestInitialFractionO2II,
                                     float CollapseTestInitialFractionOHII,
                                     float CollapseTestInitialFractionH2OII,
                                     float CollapseTestInitialFractionH3OII,
                                     float CollapseTestInitialFractionCH3I,
                                     float CollapseTestInitialFractionCH4I,
                                     float CollapseTestInitialFractionCO2I)
{
  /* declarations */

  int dim, i, j, k, m, sphere;
  int DeNum, HINum, HIINum, HeINum, HeIINum, HeIIINum, HMNum, H2INum, H2IINum,
    DINum, DIINum, HDINum, CINum, CIINum, OINum, OIINum, CHINum, CH2INum,
    COINum, OHINum, H2OINum, O2INum, COIINum, O2IINum, OHIINum, H2OIINum,
    H3OIINum, CH3INum, CH4INum, CO2INum, MetalNum;
...
#define NFW_POINTS 500
  ...
  for (SetupLoopCount = 0; SetupLoopCount < 1+min(SphereUseParticles, 1);
    ...
    float HII_Fraction, HeII_Fraction, HeIII_Fraction, H2I_Fraction,
      CI_Fraction, CII_Fraction, OI_Fraction, OII_Fraction, CHI_Fraction,
      CH2I_Fraction, COI_Fraction, OHI_Fraction, H2OI_Fraction, O2I_Fraction,
      COII_Fraction, O2II_Fraction, OHII_Fraction, H2OII_Fraction,
      H3OII_Fraction, CH3I_Fraction, CH4I_Fraction, CO2I_Fraction;
	...
	for (i = 0; i < GridDimension[0]; i++, n++) {
	  ...
	  H2I_Fraction = CollapseTestInitialFractionH2I;
          CI_Fraction = CollapseTestInitialFractionCI;
          CII_Fraction = CollapseTestInitialFractionCII;
          OI_Fraction = CollapseTestInitialFractionOI;
          OII_Fraction = CollapseTestInitialFractionOII;
          CHI_Fraction = CollapseTestInitialFractionCHI;
          CH2I_Fraction = CollapseTestInitialFractionCH2I;
          COI_Fraction = CollapseTestInitialFractionCOI;
          OHI_Fraction = CollapseTestInitialFractionOHI;
          H2OI_Fraction = CollapseTestInitialFractionH2OI;
          O2I_Fraction = CollapseTestInitialFractionO2I;
          COII_Fraction = CollapseTestInitialFractionCOII;
          O2II_Fraction = CollapseTestInitialFractionO2II;
          OHII_Fraction = CollapseTestInitialFractionOHII;
          H2OII_Fraction = CollapseTestInitialFractionH2OII;
          H3OII_Fraction = CollapseTestInitialFractionH3OII;
          CH3I_Fraction = CollapseTestInitialFractionCH3I;
          CH4I_Fraction = CollapseTestInitialFractionCH4I;
          CO2I_Fraction = CollapseTestInitialFractionCO2I;
...
//			 rcyl, zpos, ScaleHeight, dens1, temperature);
		...
		H2I_Fraction = SphereH2I[sphere];
                CI_Fraction = SphereCI[sphere];
                CII_Fraction = SphereCII[sphere];
                OI_Fraction = SphereOI[sphere];
                OII_Fraction = SphereOII[sphere];
                CHI_Fraction = SphereCHI[sphere];
                CH2I_Fraction = SphereCH2I[sphere];
                COI_Fraction = SphereCOI[sphere];
                OHI_Fraction = SphereOHI[sphere];
                H2OI_Fraction = SphereH2OI[sphere];
                O2I_Fraction = SphereO2I[sphere];
                COII_Fraction = SphereCOII[sphere];
                O2II_Fraction = SphereO2II[sphere];
                OHII_Fraction = SphereOHII[sphere];
                H2OII_Fraction = SphereH2OII[sphere];
                H3OII_Fraction = SphereH3OII[sphere];
                CH3I_Fraction = SphereCH3I[sphere];
                CH4I_Fraction = SphereCH4I[sphere];
                CO2I_Fraction = SphereCO2I[sphere];
