...
module krome_commons
  ...
  !  KROME 14.08.dev on 2020-06-16 14:06:18
  !  Changeset 2741b60
  ...
  integer,parameter::idx_O=6
  integer,parameter::idx_OH=7
  integer,parameter::idx_H2O=8
  integer,parameter::idx_O2=9
  integer,parameter::idx_CH=10
  integer,parameter::idx_CO=11
  integer,parameter::idx_C=12
  integer,parameter::idx_CO2=13
  integer,parameter::idx_CH2=14
  integer,parameter::idx_CH3=15
  integer,parameter::idx_CH4=16
  integer,parameter::idx_Hj=17
  integer,parameter::idx_HEj=18
  integer,parameter::idx_H2j=19
  integer,parameter::idx_Oj=20
  integer,parameter::idx_OHj=21
  integer,parameter::idx_H2Oj=22
  integer,parameter::idx_H3Oj=23
  integer,parameter::idx_O2j=24
  integer,parameter::idx_Cj=25
  integer,parameter::idx_COj=26
  integer,parameter::idx_HEjj=27
  integer,parameter::idx_CR=28
  integer,parameter::idx_g=29
  integer,parameter::idx_Tgas=30
  integer,parameter::idx_dummy=31
  integer,parameter::nrea=74
  integer,parameter::nmols=27
...
contains
  ...
  function get_mass()
    ...
    get_mass(6) = 2.67682601455d-23	!O
    get_mass(7) = 2.84417926637d-23	!OH
    get_mass(8) = 3.01153251819d-23	!H2O
    get_mass(9) = 5.3536520291d-23	!O2
    get_mass(10) = 2.17497276273d-23	!CH
    get_mass(11) = 4.68444552546d-23	!CO
    get_mass(12) = 2.00761951091d-23	!C
    get_mass(13) = 7.36127154001d-23	!CO2
    get_mass(14) = 2.34232601455d-23	!CH2
    get_mass(15) = 2.50967926637d-23	!CH3
    get_mass(16) = 2.67703251819d-23	!CH4
    get_mass(17) = 1.67262158d-24	!H+
    get_mass(18) = 6.69115409819d-24	!HE+
    get_mass(19) = 3.34615409819d-24	!H2+
    get_mass(20) = 2.67673492073d-23	!O+
    get_mass(21) = 2.84408817255d-23	!OH+
    get_mass(22) = 3.01144142437d-23	!H2O+
    get_mass(23) = 3.17879467619d-23	!H3O+
    get_mass(24) = 5.35356093528d-23	!O2+
    get_mass(25) = 2.00752841709d-23	!C+
    get_mass(26) = 4.68435443164d-23	!CO+
    get_mass(27) = 6.69024316d-24	!HE++
    get_mass(28) = 0.d0	!CR
    get_mass(29) = 0.d0	!g
    get_mass(30) = 0.d0	!Tgas
    get_mass(31) = 0.d0	!dummy
  ...
  function get_imass_sqrt()
    ...
    get_imass_sqrt(6) = 1.93281339991d+11	!O
    get_imass_sqrt(7) = 1.87508740611d+11	!OH
    get_imass_sqrt(8) = 1.82224271009d+11	!H2O
    get_imass_sqrt(9) = 1.36670546184d+11	!O2
    get_imass_sqrt(10) = 2.14423849574d+11	!CH
    get_imass_sqrt(11) = 1.46106959624d+11	!CO
    get_imass_sqrt(12) = 2.23182067346d+11	!C
    get_imass_sqrt(13) = 1.16553033405d+11	!CO2
    get_imass_sqrt(14) = 2.06621889668d+11	!CH2
    get_imass_sqrt(15) = 1.99613949989d+11	!CH3
    get_imass_sqrt(16) = 1.93273885081d+11	!CH4
    get_imass_sqrt(17) = 7.732165696d+11	!H+
    get_imass_sqrt(18) = 3.86588992536d+11	!HE+
    get_imass_sqrt(19) = 5.46672253003d+11	!H2+
    get_imass_sqrt(20) = 1.93284628808d+11	!O+
    get_imass_sqrt(21) = 1.87511743463d+11	!OH+
    get_imass_sqrt(22) = 1.82227027061d+11	!H2O+
    get_imass_sqrt(23) = 1.77365342346d+11	!H3O+
    get_imass_sqrt(24) = 1.36671708942d+11	!O2+
    get_imass_sqrt(25) = 2.23187130855d+11	!C+
    get_imass_sqrt(26) = 1.46108380244d+11	!CO+
    get_imass_sqrt(27) = 3.86615310465d+11	!HE++
    get_imass_sqrt(28) = 0.d0	!CR
    get_imass_sqrt(29) = 0.d0	!g
    get_imass_sqrt(30) = 0.d0	!Tgas
    get_imass_sqrt(31) = 0.d0	!dummy
  ...
  function get_imass()
    ...
    get_imass(6) = 3.73576763885d+22	!O
    get_imass(7) = 3.51595278056d+22	!OH
    get_imass(8) = 3.32056849448d+22	!H2O
    get_imass(9) = 1.86788381943d+22	!O2
    get_imass(10) = 4.59775872662d+22	!CH
    get_imass(11) = 2.13472436506d+22	!CO
    get_imass(12) = 4.98102351847d+22	!C
    get_imass(13) = 1.35846095958d+22	!CO2
    get_imass(14) = 4.26926052901d+22	!CH2
    get_imass(15) = 3.984572903d+22	!CH3
    get_imass(16) = 3.73547946544d+22	!CH4
    get_imass(17) = 5.97863863505d+23	!H+
    get_imass(18) = 1.4945104915d+23	!HE+
    get_imass(19) = 2.98850552203d+23	!H2+
    get_imass(20) = 3.73589477335d+22	!O+
    get_imass(21) = 3.51606539365d+22	!OH+
    get_imass(22) = 3.32066893916d+22	!H2O+
    get_imass(23) = 3.14584646656d+22	!H3O+
    get_imass(24) = 1.86791560251d+22	!O2+
    get_imass(25) = 4.98124953791d+22	!C+
    get_imass(26) = 2.13476587776d+22	!CO+
    get_imass(27) = 1.49471398286d+23	!HE++
    get_imass(28) = 0.d0	!CR
    get_imass(29) = 0.d0	!g
    get_imass(30) = 0.d0	!Tgas
    get_imass(31) = 0.d0	!dummy
  ...
  function get_zatoms()
    ...
    get_zatoms(11) = 14	!CO
    get_zatoms(12) = 6	!C
    get_zatoms(13) = 22	!CO2
    get_zatoms(14) = 8	!CH2
    get_zatoms(15) = 9	!CH3
    get_zatoms(16) = 10	!CH4
    get_zatoms(17) = 1	!H+
    get_zatoms(18) = 2	!HE+
    get_zatoms(19) = 2	!H2+
    get_zatoms(20) = 8	!O+
    get_zatoms(21) = 9	!OH+
    get_zatoms(22) = 10	!H2O+
    get_zatoms(23) = 11	!H3O+
    get_zatoms(24) = 16	!O2+
    get_zatoms(25) = 6	!C+
    get_zatoms(26) = 14	!CO+
    get_zatoms(27) = 2	!HE++
    get_zatoms(28) = 0	!CR
    get_zatoms(29) = 0	!g
    get_zatoms(30) = 0	!Tgas
    get_zatoms(31) = 0	!dummy
  ...
  function get_charges()
    ...
    get_charges(6) = 0.d0 	!O
    get_charges(7) = 0.d0 	!OH
    get_charges(8) = 0.d0 	!H2O
    get_charges(9) = 0.d0 	!O2
    get_charges(10) = 0.d0 	!CH
    get_charges(11) = 0.d0 	!CO
    get_charges(12) = 0.d0 	!C
    get_charges(13) = 0.d0 	!CO2
    get_charges(14) = 0.d0 	!CH2
    get_charges(15) = 0.d0 	!CH3
    get_charges(16) = 0.d0 	!CH4
    get_charges(17) = 1.d0 	!H+
    get_charges(18) = 1.d0 	!HE+
    get_charges(19) = 1.d0 	!H2+
    get_charges(20) = 1.d0 	!O+
    get_charges(21) = 1.d0 	!OH+
    get_charges(22) = 1.d0 	!H2O+
    get_charges(23) = 1.d0 	!H3O+
    get_charges(24) = 1.d0 	!O2+
    get_charges(25) = 1.d0 	!C+
    get_charges(26) = 1.d0 	!CO+
    get_charges(27) = 2.d0 	!HE++
    get_charges(28) = 0.d0 	!CR
    get_charges(29) = 0.d0 	!g
    get_charges(30) = 0.d0 	!Tgas
    get_charges(31) = 0.d0 	!dummy
...
contains
  ...
  ! *************************************************************
  !  This file has been generated with:
  !  KROME 14.08.dev on 2020-06-16 14:06:19
  !  Changeset 2741b60
  !  see http://kromepackage.org
  !
  !  Written and developed by Tommaso Grassi and Stefano Bovino
...
contains
  ...
  ! *************************************************************
  !  This file has been generated with:
  !  KROME 14.08.dev on 2020-06-16 14:06:20
  !  Changeset 2741b60
  !  see http://kromepackage.org
  !
  !  Written and developed by Tommaso Grassi and Stefano Bovino
  ...
  function coe(n)
    ...
    !O + H -> OH
    k(39) = small + (9.90d-19*(T32)**(-0.38))

    !O + H2 -> OH + H
    k(40) = small + (3.43d-13*(T32)**2.67&
        *exp(-3160*invT))

    !H2 + OH -> H2O + H
    k(41) = small + (1.55d-12*(T32)**1.60&
        *exp(-1660*invT))

    !OH + OH -> H2O + O
    k(42) = small + (1.65d-12*(T32)**1.14&
        *exp(-50*invT))
    ...
    !H + OH -> H2 + O
    k(45) = small + (7.00d-14*(T32)**2.80&
        *exp(-1950*invT))

    !H + H2O -> OH + H2
    k(46) = small + (6.83d-12*(T32)**1.60&
        *exp(-9720*invT))

    !O + O -> O2
    k(47) = small + (4.90d-20*(T32)**1.58)

    !O + OH -> O2 + H
    k(48) = small + (4.34d-11*(T32)**(-0.50)&
        *exp(-30*invT))

    !H + O2 -> OH + O
    k(49) = small + (3.30d-10*exp(-8460&
        *invT))
    ...
    !O2+ + E -> O + O
    k(51) = small + (1.95d-7*(T32)**(-0.70))

    !O + CH -> CO + H
    k(52) = small + (6.60d-11)

    !C + OH -> CO + H
    k(53) = small + (1.10d-10*(T32)**0.50)
    ...
    !H2 + CH2 -> CH3 + H
    k(65) = small + (5.18d-11*(T32)**0.17&
        *exp(-6400*invT))

    !H + CH3 -> CH2 + H2
    k(66) = small + (1.00d-10*exp(-7600&
        *invT))

    !H2 + CH3 -> CH4 + H
    k(67) = small + (6.86d-14*(T32)**2.74&
        *exp(-4740*invT))

    !H + CH4 -> H2 + CH3
    k(68) = small + (5.82d-13*(T32)**3.00&
        *exp(-4045*invT))
    ...
    !OH+ + E -> O + H
    k(71) = small + (6.3d-9*(T32)**(-0.48))

    !O+ + E -> O
    k(72) = small + ( 0.34d-11*T32**(-0.63))

    !CO+ + E -> CO
    k(73) = small + ( recV96(Tgas, 2.510d-13, 7.950d-01))

    !CO+ + E -> C + O
    k(74) = small + ( 0.275d-6*T32**(-0.55))
  ...
  function revHS(Tgas,idx)
    ...
    real*8::p1_nasa(31,7), p2_nasa(31,7), Tlim_nasa(31,3), p(7)
    real*8::p1_nist(31,7), p2_nist(31,7), Tlim_nist(31,3)
    integer::idx
  ...
  subroutine load_arrays()
    ...
    arr_r1(1:74) = (/3,17,17,4,18,18,18,27,3,2,3,3,19,5,5,5,5,2&
        ,2,2,2,2,19,19,3,5,5,18,4,4,20,17,20,21,22,22,22,23,6,6,5,7&
        ,17,17,3,3,6,6,3,17,24,6,12,12,25,7,25,25,26,12,12,3,5,3,5,3&
        ,5,3,5,23,21,20,26,26/)
    arr_r2(1:74) = (/1,1,1,1,1,1,1,1,1&
        ,3,17,17,3,17,1,1,3,1,3,3,17,17,1,2,3,3,5,3,17,17,3,6,5,5,5,1&
        ,1,1,3,5,7,7,7,8,7,8,6,7,9,9,1,10,7,9,9,11,1,7,3,3,5,10,10,14&
        ,14,15,15,16,12,1,1,1,1,1/)
    arr_r3(1:74) = (/31,31,31,31&
        ,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31&
        ,3,3,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31&
        ,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31&
        ,31,31,31,31,31,31,31,31,31/)
    arr_p1(1:74) = (/17,3,3,18,4&
        ,4,27,18,2,5,19,19,5,19,3,3,3,3,3,3,3,19,3,3,5,5,3,4,18,18,17&
        ,20,21,22,23,6,7,8,7,7,8,8,21,22,5,7,9,9,7,24,6,11,11,11,20&
        ,13,12,26,17,10,10,12,14,10,15,14,16,5,14,7,6,6,11&
        ,12/)
    arr_p2(1:74) = (/1,31,31,1,31,31,1,31,31,1,31,31,17&
        ,3,2,3,3,1,3,3,3,1,3,5,3,5,3,17,3,3,6,3,3,3,3,5,3,3,31,3,3,6&
        ,3,3,6,5,31,3,6,3,6,3,3,6,11,3,31,3,11,31,3,5,3,5,3,5,3,15,31&
        ,3,3,31,31,6/)
    arr_p3(1:74) = (/1,31,31,1,31,31,1,31,31,31&
        ,31,31,31,31,31,1,3,1,1,1,31,31,31,31,31,31,5,31,31,31,31,31&
        ,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31&
        ,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,3,31,31&
        ,31,31/)
...
contains
  ...
  function coe_tab(n)
    ...
    real*8::a21,Hnuclei,sumsav,asav,ncr21,a11,a10,a12,invT,a1,a3,a2,a5,T,a7,a6,a9,a8,kh21,kl21,bsav1,bsav3,bsav2,bsav5,bsav4,bsav7,bsav6,bsav8,a4
    ...
    !non tabulated rates
    !H2 + H2 -> H + H + H2
    coe_tab(27) = small + (kh21**(1.-a21)&
        *kl21**a21)

    if(sum(n(1:nmols))>1d14)coe_tab(31:71)=0d0
...
contains
  ...
  subroutine fex(neq,tt,nin,dn)
    ...
    dn(idx_E) = &
        ...
        -k(36)*n(idx_H2Oj)*n(idx_E) &
        -k(37)*n(idx_H2Oj)*n(idx_E) &
        -k(38)*n(idx_H3Oj)*n(idx_E) &
        -k(51)*n(idx_O2j)*n(idx_E) &
        -k(57)*n(idx_Cj)*n(idx_E) &
        -k(70)*n(idx_H3Oj)*n(idx_E) &
        -k(71)*n(idx_OHj)*n(idx_E) &
        -k(72)*n(idx_Oj)*n(idx_E) &
        -k(73)*n(idx_COj)*n(idx_E) &
        -k(74)*n(idx_COj)*n(idx_E)
    ...
    dn(idx_H) = &
        ...
        -k(31)*n(idx_Oj)*n(idx_H) &
        +k(32)*n(idx_Hj)*n(idx_O) &
        +k(33)*n(idx_Oj)*n(idx_H2) &
        +k(34)*n(idx_OHj)*n(idx_H2) &
        +k(35)*n(idx_H2Oj)*n(idx_H2) &
        +k(37)*n(idx_H2Oj)*n(idx_E) &
        +k(38)*n(idx_H3Oj)*n(idx_E) &
        -k(39)*n(idx_O)*n(idx_H) &
        +k(40)*n(idx_O)*n(idx_H2) &
        +k(41)*n(idx_H2)*n(idx_OH) &
        +k(43)*n(idx_Hj)*n(idx_OH) &
        +k(44)*n(idx_Hj)*n(idx_H2O) &
        -k(45)*n(idx_H)*n(idx_OH) &
        -k(46)*n(idx_H)*n(idx_H2O) &
        +k(48)*n(idx_O)*n(idx_OH) &
        -k(49)*n(idx_H)*n(idx_O2) &
        +k(50)*n(idx_Hj)*n(idx_O2) &
        +k(52)*n(idx_O)*n(idx_CH) &
        +k(53)*n(idx_C)*n(idx_OH) &
        +k(56)*n(idx_OH)*n(idx_CO) &
        +k(58)*n(idx_Cj)*n(idx_OH) &
        -k(59)*n(idx_COj)*n(idx_H) &
        -k(60)*n(idx_C)*n(idx_H) &
        +k(61)*n(idx_C)*n(idx_H2) &
        -k(62)*n(idx_H)*n(idx_CH) &
        +k(63)*n(idx_H2)*n(idx_CH) &
        -k(64)*n(idx_H)*n(idx_CH2) &
        +k(65)*n(idx_H2)*n(idx_CH2) &
        -k(66)*n(idx_H)*n(idx_CH3) &
        +k(67)*n(idx_H2)*n(idx_CH3) &
        -k(68)*n(idx_H)*n(idx_CH4) &
        +2.d0*k(70)*n(idx_H3Oj)*n(idx_E) &
        +k(71)*n(idx_OHj)*n(idx_E)
    ...
    dn(idx_O) = &
        ...
        -k(39)*n(idx_O)*n(idx_H) &
        -k(40)*n(idx_O)*n(idx_H2) &
        +k(42)*n(idx_OH)*n(idx_OH) &
        +k(45)*n(idx_H)*n(idx_OH) &
        -2.d0*k(47)*n(idx_O)*n(idx_O) &
        -k(48)*n(idx_O)*n(idx_OH) &
        +k(49)*n(idx_H)*n(idx_O2) &
        +2.d0*k(51)*n(idx_O2j)*n(idx_E) &
        -k(52)*n(idx_O)*n(idx_CH) &
        +k(54)*n(idx_C)*n(idx_O2) &
        +k(71)*n(idx_OHj)*n(idx_E) &
        +k(72)*n(idx_Oj)*n(idx_E) &
        +k(74)*n(idx_COj)*n(idx_E)
    ...
    !O2
    dn(idx_O2) = &
        +k(47)*n(idx_O)*n(idx_O) &
        +k(48)*n(idx_O)*n(idx_OH) &
        -k(49)*n(idx_H)*n(idx_O2) &
        -k(50)*n(idx_Hj)*n(idx_O2) &
        -k(54)*n(idx_C)*n(idx_O2) &
        -k(55)*n(idx_Cj)*n(idx_O2)
...
module krome_user
  ...
  integer,parameter::KROME_idx_O = 6	!O
  integer,parameter::KROME_idx_OH = 7	!OH
  integer,parameter::KROME_idx_H2O = 8	!H2O
  integer,parameter::KROME_idx_O2 = 9	!O2
  integer,parameter::KROME_idx_CH = 10	!CH
  integer,parameter::KROME_idx_CO = 11	!CO
  integer,parameter::KROME_idx_C = 12	!C
  integer,parameter::KROME_idx_CO2 = 13	!CO2
  integer,parameter::KROME_idx_CH2 = 14	!CH2
  integer,parameter::KROME_idx_CH3 = 15	!CH3
  integer,parameter::KROME_idx_CH4 = 16	!CH4
  integer,parameter::KROME_idx_Hj = 17	!H+
  integer,parameter::KROME_idx_HEj = 18	!HE+
  integer,parameter::KROME_idx_H2j = 19	!H2+
  integer,parameter::KROME_idx_Oj = 20	!O+
  integer,parameter::KROME_idx_OHj = 21	!OH+
  integer,parameter::KROME_idx_H2Oj = 22	!H2O+
  integer,parameter::KROME_idx_H3Oj = 23	!H3O+
  integer,parameter::KROME_idx_O2j = 24	!O2+
  integer,parameter::KROME_idx_Cj = 25	!C+
  integer,parameter::KROME_idx_COj = 26	!CO+
  integer,parameter::KROME_idx_HEjj = 27	!HE++
  integer,parameter::KROME_idx_CR = 28	!CR
  integer,parameter::KROME_idx_g = 29	!g
  integer,parameter::KROME_idx_Tgas = 30	!Tgas
  integer,parameter::KROME_idx_dummy = 31	!dummy
  ...
  integer,parameter::krome_nrea=74
  integer,parameter::krome_nmols=27
  integer,parameter::krome_nspec=31
...
contains
  ...
  function krome_get_names_header()
    ...
    use krome_getphys
    implicit none
    character*93::krome_get_names_header
    character*16::tmp(nspec)
    integer::i
