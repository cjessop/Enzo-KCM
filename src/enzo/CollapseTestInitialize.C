...
static float CollapseTestInitialFractionCI    = 1.0e-20;
static float CollapseTestInitialFractionCII   = 1.0e-20;
static float CollapseTestInitialFractionOI    = 1.0e-20;
static float CollapseTestInitialFractionOII   = 1.0e-20;
static float CollapseTestInitialFractionCHI   = 1.0e-20;
static float CollapseTestInitialFractionCH2I  = 1.0e-20;
static float CollapseTestInitialFractionCOI   = 1.0e-20;
static float CollapseTestInitialFractionOHI   = 1.0e-20;
static float CollapseTestInitialFractionH2OI  = 1.0e-20;
static float CollapseTestInitialFractionO2I   = 1.0e-20;
static float CollapseTestInitialFractionCOII  = 1.0e-20;
static float CollapseTestInitialFractionO2II  = 1.0e-20;
static float CollapseTestInitialFractionOHII  = 1.0e-20;
static float CollapseTestInitialFractionH2OII = 1.0e-20;
static float CollapseTestInitialFractionH3OII = 1.0e-20;
static float CollapseTestInitialFractionCH3I  = 1.0e-20;
static float CollapseTestInitialFractionCH4I  = 1.0e-20;
static float CollapseTestInitialFractionCO2I  = 1.0e-20;
			  ...
			  HierarchyEntry &TopGrid, TopGridData &MetaData, ExternalBoundary &Exterior)
{
  ...
  float CollapseTestSphereDensity[MAX_SPHERES],
    ...
    CollapseTestSphereCIFraction[MAX_SPHERES],
    CollapseTestSphereCIIFraction[MAX_SPHERES],
    CollapseTestSphereOIFraction[MAX_SPHERES],
    CollapseTestSphereOIIFraction[MAX_SPHERES],
    CollapseTestSphereCHIFraction[MAX_SPHERES],
    CollapseTestSphereCH2IFraction[MAX_SPHERES],
    CollapseTestSphereCOIFraction[MAX_SPHERES],
    CollapseTestSphereOHIFraction[MAX_SPHERES],
    CollapseTestSphereH2OIFraction[MAX_SPHERES],
    CollapseTestSphereO2IFraction[MAX_SPHERES],
    CollapseTestSphereCOIIFraction[MAX_SPHERES],
    CollapseTestSphereO2IIFraction[MAX_SPHERES],
    CollapseTestSphereOHIIFraction[MAX_SPHERES],
    CollapseTestSphereH2OIIFraction[MAX_SPHERES],
    CollapseTestSphereH3OIIFraction[MAX_SPHERES],
    CollapseTestSphereCH3IFraction[MAX_SPHERES],
    CollapseTestSphereCH4IFraction[MAX_SPHERES],
    CollapseTestSphereCO2IFraction[MAX_SPHERES],
  ...
  for (sphere = 0; sphere < MAX_SPHERES; sphere++) {
    ...
    CollapseTestSphereCIFraction[sphere] = CollapseTestInitialFractionCI;
    CollapseTestSphereCIIFraction[sphere] = CollapseTestInitialFractionCII;
    CollapseTestSphereOIFraction[sphere] = CollapseTestInitialFractionOI;
    CollapseTestSphereOIIFraction[sphere] = CollapseTestInitialFractionOII;
    CollapseTestSphereCHIFraction[sphere] = CollapseTestInitialFractionCHI;
    CollapseTestSphereCH2IFraction[sphere] = CollapseTestInitialFractionCH2I;
    CollapseTestSphereCOIFraction[sphere] = CollapseTestInitialFractionCOI;
    CollapseTestSphereOHIFraction[sphere] = CollapseTestInitialFractionOHI;
    CollapseTestSphereH2OIFraction[sphere] = CollapseTestInitialFractionH2OI;
    CollapseTestSphereO2IFraction[sphere] = CollapseTestInitialFractionO2I;
    CollapseTestSphereCOIIFraction[sphere] = CollapseTestInitialFractionCOII;
    CollapseTestSphereO2IIFraction[sphere] = CollapseTestInitialFractionO2II;
    CollapseTestSphereOHIIFraction[sphere] = CollapseTestInitialFractionOHII;
    CollapseTestSphereH2OIIFraction[sphere] = CollapseTestInitialFractionH2OII;
    CollapseTestSphereH3OIIFraction[sphere] = CollapseTestInitialFractionH3OII;
    CollapseTestSphereCH3IFraction[sphere] = CollapseTestInitialFractionCH3I;
    CollapseTestSphereCH4IFraction[sphere] = CollapseTestInitialFractionCH4I;
    CollapseTestSphereCO2IFraction[sphere] = CollapseTestInitialFractionCO2I;
  ...
  while (fgets(line, MAX_LINE_LENGTH, fptr) != NULL) {
    ...
    if (sscanf(line, "CollapseTestSphereCIFraction[%"ISYM"]", &sphere) > 0)
      ret += sscanf(line, "CollapseTestSphereCIFraction[%"ISYM"] = %"FSYM, &sphere,
                    &CollapseTestSphereCIFraction[sphere]);
    if (sscanf(line, "CollapseTestSphereCIIFraction[%"ISYM"]", &sphere) > 0)
      ret += sscanf(line, "CollapseTestSphereCIIFraction[%"ISYM"] = %"FSYM, &sphere,
                    &CollapseTestSphereCIIFraction[sphere]);

    if (sscanf(line, "CollapseTestSphereOIFraction[%"ISYM"]", &sphere) > 0)
      ret += sscanf(line, "CollapseTestSphereOIFraction[%"ISYM"] = %"FSYM, &sphere,
                    &CollapseTestSphereOIFraction[sphere]);

    if (sscanf(line, "CollapseTestSphereOIIFraction[%"ISYM"]", &sphere) > 0)
      ret += sscanf(line, "CollapseTestSphereOIIFraction[%"ISYM"] = %"FSYM, &sphere,
                    &CollapseTestSphereOIIFraction[sphere]);

    if (sscanf(line, "CollapseTestSphereCHIFraction[%"ISYM"]", &sphere) > 0)
      ret += sscanf(line, "CollapseTestSphereCHIFraction[%"ISYM"] = %"FSYM, &sphere,
                    &CollapseTestSphereCHIFraction[sphere]);

    if (sscanf(line, "CollapseTestSphereCH2IFraction[%"ISYM"]", &sphere) > 0)
      ret += sscanf(line, "CollapseTestSphereCH2IFraction[%"ISYM"] = %"FSYM, &sphere,
                    &CollapseTestSphereCH2IFraction[sphere]);

    if (sscanf(line, "CollapseTestSphereCOIFraction[%"ISYM"]", &sphere) > 0)
      ret += sscanf(line, "CollapseTestSphereCOIFraction[%"ISYM"] = %"FSYM, &sphere,
                    &CollapseTestSphereCOIFraction[sphere]);

    if (sscanf(line, "CollapseTestSphereOHIFraction[%"ISYM"]", &sphere) > 0)
      ret += sscanf(line, "CollapseTestSphereOHIFraction[%"ISYM"] = %"FSYM, &sphere,
                    &CollapseTestSphereOHIFraction[sphere]);

    if (sscanf(line, "CollapseTestSphereH2OIFraction[%"ISYM"]", &sphere) > 0)
      ret += sscanf(line, "CollapseTestSphereH2OIFraction[%"ISYM"] = %"FSYM, &sphere,
                    &CollapseTestSphereH2OIFraction[sphere]);

    if (sscanf(line, "CollapseTestSphereO2IFraction[%"ISYM"]", &sphere) > 0)
      ret += sscanf(line, "CollapseTestSphereO2IFraction[%"ISYM"] = %"FSYM, &sphere,
                    &CollapseTestSphereO2IFraction[sphere]);

    if (sscanf(line, "CollapseTestSphereCOIIFraction[%"ISYM"]", &sphere) > 0)
      ret += sscanf(line, "CollapseTestSphereCOIIFraction[%"ISYM"] = %"FSYM, &sphere,
                    &CollapseTestSphereCOIIFraction[sphere]);

    if (sscanf(line, "CollapseTestSphereO2IIFraction[%"ISYM"]", &sphere) > 0)
      ret += sscanf(line, "CollapseTestSphereO2IIFraction[%"ISYM"] = %"FSYM, &sphere,
                    &CollapseTestSphereO2IIFraction[sphere]);

    if (sscanf(line, "CollapseTestSphereOHIIFraction[%"ISYM"]", &sphere) > 0)
      ret += sscanf(line, "CollapseTestSphereOHIIFraction[%"ISYM"] = %"FSYM, &sphere,
                    &CollapseTestSphereOHIIFraction[sphere]);

    if (sscanf(line, "CollapseTestSphereH2OIIFraction[%"ISYM"]", &sphere) > 0)
      ret += sscanf(line, "CollapseTestSphereH2OIIFraction[%"ISYM"] = %"FSYM, &sphere,
                    &CollapseTestSphereH2OIIFraction[sphere]);

    if (sscanf(line, "CollapseTestSphereH3OIIFraction[%"ISYM"]", &sphere) > 0)
      ret += sscanf(line, "CollapseTestSphereH3OIIFraction[%"ISYM"] = %"FSYM, &sphere,
                    &CollapseTestSphereH3OIIFraction[sphere]);

    if (sscanf(line, "CollapseTestSphereCH3IFraction[%"ISYM"]", &sphere) > 0)
      ret += sscanf(line, "CollapseTestSphereCH3IFraction[%"ISYM"] = %"FSYM, &sphere,
                    &CollapseTestSphereCH3IFraction[sphere]);

    if (sscanf(line, "CollapseTestSphereCH4IFraction[%"ISYM"]", &sphere) > 0)
      ret += sscanf(line, "CollapseTestSphereCH4IFraction[%"ISYM"] = %"FSYM, &sphere,
                    &CollapseTestSphereCH4IFraction[sphere]);

    if (sscanf(line, "CollapseTestSphereCO2IFraction[%"ISYM"]", &sphere) > 0)
      ret += sscanf(line, "CollapseTestSphereCO2IFraction[%"ISYM"] = %"FSYM, &sphere,
                    &CollapseTestSphereCO2IFraction[sphere]);
    ...
    ret += sscanf(line, "CollapseTestInitialFractionCI = %"FSYM,
                  &CollapseTestInitialFractionCI);
    ret += sscanf(line, "CollapseTestInitialFractionCII = %"FSYM,
                  &CollapseTestInitialFractionCII);
    ret += sscanf(line, "CollapseTestInitialFractionOI = %"FSYM,
                  &CollapseTestInitialFractionOI);
    ret += sscanf(line, "CollapseTestInitialFractionOII = %"FSYM,
                  &CollapseTestInitialFractionOII);
    ret += sscanf(line, "CollapseTestInitialFractionCHI = %"FSYM,
                  &CollapseTestInitialFractionCHI);
    ret += sscanf(line, "CollapseTestInitialFractionCH2I = %"FSYM,
                  &CollapseTestInitialFractionCH2I);
    ret += sscanf(line, "CollapseTestInitialFractionCOI = %"FSYM,
                  &CollapseTestInitialFractionCOI);
    ret += sscanf(line, "CollapseTestInitialFractionOHI = %"FSYM,
                  &CollapseTestInitialFractionOHI);
    ret += sscanf(line, "CollapseTestInitialFractionH2OI = %"FSYM,
                  &CollapseTestInitialFractionH2OI);
    ret += sscanf(line, "CollapseTestInitialFractionO2I = %"FSYM,
                  &CollapseTestInitialFractionO2I);
    ret += sscanf(line, "CollapseTestInitialFractionCOII = %"FSYM,
                  &CollapseTestInitialFractionCOII);
    ret += sscanf(line, "CollapseTestInitialFractionO2II = %"FSYM,
                  &CollapseTestInitialFractionO2II);
    ret += sscanf(line, "CollapseTestInitialFractionOHII = %"FSYM,
                  &CollapseTestInitialFractionOHII);
    ret += sscanf(line, "CollapseTestInitialFractionH2OII = %"FSYM,
                  &CollapseTestInitialFractionH2OII);
    ret += sscanf(line, "CollapseTestInitialFractionH3OII = %"FSYM,
                  &CollapseTestInitialFractionH3OII);
    ret += sscanf(line, "CollapseTestInitialFractionCH3I = %"FSYM,
                  &CollapseTestInitialFractionCH3I);
    ret += sscanf(line, "CollapseTestInitialFractionCH4I = %"FSYM,
                  &CollapseTestInitialFractionCH4I);
    ret += sscanf(line, "CollapseTestInitialFractionCO2I = %"FSYM,
                  &CollapseTestInitialFractionCO2I);
  ...
  if (TopGrid.GridData->CollapseTestInitializeGrid(
	     ...
	     CollapseTestSphereHeIIIFraction, CollapseTestSphereH2IFraction,
             CollapseTestSphereCIFraction, CollapseTestSphereCIIFraction,
       	     CollapseTestSphereOIFraction, CollapseTestSphereOIIFraction,
       	     CollapseTestSphereCHIFraction, CollapseTestSphereCH2IFraction,
       	     CollapseTestSphereCOIFraction, CollapseTestSphereOHIFraction,
       	     CollapseTestSphereH2OIFraction, CollapseTestSphereO2IFraction,
       	     CollapseTestSphereCOIIFraction, CollapseTestSphereO2IIFraction,
       	     CollapseTestSphereOHIIFraction, CollapseTestSphereH2OIIFraction,
       	     CollapseTestSphereH3OIIFraction, CollapseTestSphereCH3IFraction,
       	     CollapseTestSphereCH4IFraction, CollapseTestSphereCO2IFraction,
	     ...
	     CollapseTestInitialFractionH2I, CollapseTestInitialFractionH2II,
             CollapseTestInitialFractionCI, CollapseTestInitialFractionCII,
             CollapseTestInitialFractionOI, CollapseTestInitialFractionOII,
             CollapseTestInitialFractionCHI, CollapseTestInitialFractionCH2I,
             CollapseTestInitialFractionCOI, CollapseTestInitialFractionOHI,
             CollapseTestInitialFractionH2OI, CollapseTestInitialFractionO2I,
             CollapseTestInitialFractionCOII, CollapseTestInitialFractionO2II,
             CollapseTestInitialFractionOHII, CollapseTestInitialFractionH2OII,
             CollapseTestInitialFractionH3OII, CollapseTestInitialFractionCH3I,
             CollapseTestInitialFractionCH4I, CollapseTestInitialFractionCO2I) == FAIL) {
  ...
  if (MyProcessorNumber == ROOT_PROCESSOR) {
    ...
    for (sphere = 0; sphere < CollapseTestNumberOfSpheres; sphere++) {
      ...
      fprintf(Outfptr, "CollapseTestSphereH2IFraction[%"ISYM"] = %"GOUTSYM"\n", sphere,
	      CollapseTestSphereH2IFraction[sphere]);
      fprintf(Outfptr, "CollapseTestSphereCIFraction[%"ISYM"] = %"GOUTSYM"\n", sphere,
              CollapseTestSphereCIFraction[sphere]);
      fprintf(Outfptr, "CollapseTestSphereCIIFraction[%"ISYM"] = %"GOUTSYM"\n", sphere,
              CollapseTestSphereCIIFraction[sphere]);
      fprintf(Outfptr, "CollapseTestSphereOIFraction[%"ISYM"] = %"GOUTSYM"\n", sphere,
              CollapseTestSphereOIFraction[sphere]);
      fprintf(Outfptr, "CollapseTestSphereOIIFraction[%"ISYM"] = %"GOUTSYM"\n", sphere,
              CollapseTestSphereOIIFraction[sphere]);
      fprintf(Outfptr, "CollapseTestSphereCHIFraction[%"ISYM"] = %"GOUTSYM"\n", sphere,
              CollapseTestSphereCHIFraction[sphere]);
      fprintf(Outfptr, "CollapseTestSphereCH2IFraction[%"ISYM"] = %"GOUTSYM"\n", sphere,
              CollapseTestSphereCH2IFraction[sphere]);
      fprintf(Outfptr, "CollapseTestSphereCOIFraction[%"ISYM"] = %"GOUTSYM"\n", sphere,
              CollapseTestSphereCOIFraction[sphere]);
      fprintf(Outfptr, "CollapseTestSphereOHIFraction[%"ISYM"] = %"GOUTSYM"\n", sphere,
              CollapseTestSphereOHIFraction[sphere]);
      fprintf(Outfptr, "CollapseTestSphereH2OIFraction[%"ISYM"] = %"GOUTSYM"\n", sphere,
              CollapseTestSphereH2OIFraction[sphere]);
      fprintf(Outfptr, "CollapseTestSphereO2IFraction[%"ISYM"] = %"GOUTSYM"\n", sphere,
              CollapseTestSphereO2IFraction[sphere]);
      fprintf(Outfptr, "CollapseTestSphereCOIIFraction[%"ISYM"] = %"GOUTSYM"\n", sphere,
              CollapseTestSphereCOIIFraction[sphere]);
      fprintf(Outfptr, "CollapseTestSphereO2IIFraction[%"ISYM"] = %"GOUTSYM"\n", sphere,
              CollapseTestSphereO2IIFraction[sphere]);
      fprintf(Outfptr, "CollapseTestSphereOHIIFraction[%"ISYM"] = %"GOUTSYM"\n", sphere,
              CollapseTestSphereOHIIFraction[sphere]);
      fprintf(Outfptr, "CollapseTestSphereH2OIIFraction[%"ISYM"] = %"GOUTSYM"\n", sphere,
              CollapseTestSphereH2OIIFraction[sphere]);
      fprintf(Outfptr, "CollapseTestSphereH3OIIFraction[%"ISYM"] = %"GOUTSYM"\n", sphere,
              CollapseTestSphereH3OIIFraction[sphere]);
      fprintf(Outfptr, "CollapseTestSphereCH3IFraction[%"ISYM"] = %"GOUTSYM"\n", sphere,
              CollapseTestSphereCH3IFraction[sphere]);
      fprintf(Outfptr, "CollapseTestSphereCH4IFraction[%"ISYM"] = %"GOUTSYM"\n", sphere,
              CollapseTestSphereCH4IFraction[sphere]);
      fprintf(Outfptr, "CollapseTestSphereCO2IFraction[%"ISYM"] = %"GOUTSYM"\n", sphere,
              CollapseTestSphereCO2IFraction[sphere]);
    }
  }
