			      ...
			      fluxes *SubgridFluxes[], int level)
{
  ...
  if (NumberOfBaryonFields > 0) {
    ...
    // Copy the routine below and replace MultiSpecies with KCM flag + remove the Radiative Transfer FLD flag
    ...
    if (MultiSpecies > 0 && RadiativeTransferFLD != 2) {
      NumberOfColours = 6 + 3*(MultiSpecies-1) + 18;
	...
	if ((ColourNum =
	  ...
	  colnum[++NumberOfColours] = ColourNum;
        if ((ColourNum =
             FindField(CIDensity, FieldType, NumberOfBaryonFields)) >= 0)
          colnum[++NumberOfColours] = ColourNum;
        if ((ColourNum =
             FindField(CIIDensity, FieldType, NumberOfBaryonFields)) >= 0)
          colnum[++NumberOfColours] = ColourNum;
        if ((ColourNum =
             FindField(OIDensity, FieldType, NumberOfBaryonFields)) >= 0)
          colnum[++NumberOfColours] = ColourNum;
        if ((ColourNum =
             FindField(OIIDensity, FieldType, NumberOfBaryonFields)) >= 0)
          colnum[++NumberOfColours] = ColourNum;
        if ((ColourNum =
             FindField(CHIDensity, FieldType, NumberOfBaryonFields)) >= 0)
          colnum[++NumberOfColours] = ColourNum;
        if ((ColourNum =
             FindField(CH2IDensity, FieldType, NumberOfBaryonFields)) >= 0)
          colnum[++NumberOfColours] = ColourNum;
        if ((ColourNum =
             FindField(COIDensity, FieldType, NumberOfBaryonFields)) >= 0)
          colnum[++NumberOfColours] = ColourNum;
        if ((ColourNum =
             FindField(OHIDensity, FieldType, NumberOfBaryonFields)) >= 0)
          colnum[++NumberOfColours] = ColourNum;
        if ((ColourNum =
             FindField(H2OIDensity, FieldType, NumberOfBaryonFields)) >= 0)
          colnum[++NumberOfColours] = ColourNum;
        if ((ColourNum =
             FindField(O2IDensity, FieldType, NumberOfBaryonFields)) >= 0)
          colnum[++NumberOfColours] = ColourNum;
        if ((ColourNum =
             FindField(COIIDensity, FieldType, NumberOfBaryonFields)) >= 0)
          colnum[++NumberOfColours] = ColourNum;
        if ((ColourNum =
             FindField(O2IIDensity, FieldType, NumberOfBaryonFields)) >= 0)
          colnum[++NumberOfColours] = ColourNum;
        if ((ColourNum =
             FindField(OHIIDensity, FieldType, NumberOfBaryonFields)) >= 0)
          colnum[++NumberOfColours] = ColourNum;
        if ((ColourNum =
             FindField(H2OIIDensity, FieldType, NumberOfBaryonFields)) >= 0)
          colnum[++NumberOfColours] = ColourNum;
        if ((ColourNum =
             FindField(H3OIIDensity, FieldType, NumberOfBaryonFields)) >= 0)
          colnum[++NumberOfColours] = ColourNum;
        if ((ColourNum =
             FindField(CH3IDensity, FieldType, NumberOfBaryonFields)) >= 0)
          colnum[++NumberOfColours] = ColourNum;
        if ((ColourNum =
             FindField(CH4IDensity, FieldType, NumberOfBaryonFields)) >= 0)
          colnum[++NumberOfColours] = ColourNum;
        if ((ColourNum =
             FindField(CO2IDensity, FieldType, NumberOfBaryonFields)) >= 0)
          colnum[++NumberOfColours] = ColourNum;
