...
int grid::SolveOneZoneFreefall()
{
  ...
  int DeNum, HINum, HIINum, HeINum, HeIINum, HeIIINum, HMNum, H2INum, H2IINum,
      ...
      H3OIINum, CH3INum, CH4INum, CO2INum;
  FLOAT a = 1.0, dadt;
	  ...
	  fprintf(stderr, "One-zone collapse: rho[%"ISYM", %"ISYM", %"ISYM"] = %"ESYM" g/cm^3, f = %"FSYM,
        ...
        if (MultiSpecies) {
          ...
          if (MultiSpecies > 1) {
            ...
            BaryonField[CINum][index] *= DensityRatio;
            BaryonField[CIINum][index] *= DensityRatio;
            BaryonField[OINum][index] *= DensityRatio;
            BaryonField[OIINum][index] *= DensityRatio;
            BaryonField[CHINum][index] *= DensityRatio;
            BaryonField[CH2INum][index] *= DensityRatio;
            BaryonField[COINum][index] *= DensityRatio;
            BaryonField[OHINum][index] *= DensityRatio;
            BaryonField[H2OINum][index] *= DensityRatio;
            BaryonField[O2INum][index] *= DensityRatio;
            BaryonField[COIINum][index] *= DensityRatio;
            BaryonField[O2IINum][index] *= DensityRatio;
            BaryonField[OHIINum][index] *= DensityRatio;
            BaryonField[H2OIINum][index] *= DensityRatio;
            BaryonField[H3OIINum][index] *= DensityRatio;
            BaryonField[CH3INum][index] *= DensityRatio;
            BaryonField[CH4INum][index] *= DensityRatio;
            BaryonField[CO2INum][index] *= DensityRatio;
	    if (index == max_rho_index) {
