				...
				float UniformCR)
{
  ...
  int CINum, CIINum, OINum, OIINum, SiINum, SiIINum, SiIIINum, CHINum, CH2INum, 
    CH3IINum, C2INum, COINum, HCOIINum, OHINum, H2OINum, O2INum, COIINum, O2IINum;
  ...
  //KCM network species additions

  if (TestProblemData.KCM > 0) {
  ...
  for (i = 0; i < size; i++){
    ...
    // Set KCM fields
    // Following format from MultiSpecies
    if (KCM > 0) {
	...
	BaryonField[O2INum  ][i] = TestProblemData.O2I_Fraction * UniformDensity;
     ...
     BaryonField[H2OINum  ][i] = TestProblemData.H2OI_Fraction * UniformDensity;
     BaryonField[O2INum  ][i] = TestProblemData.O2I_Fraction * UniformDensity;
     BaryonField[COIINum  ][i] = TestProblemData.COII_Fraction * UniformDensity;
     BaryonField[O2IINum  ][i] = TestProblemData.O2II_Fraction * UniformDensity;
     BaryonField[OHIINum  ][i] = TestProblemData.OHII_Fraction * UniformDensity;
     BaryonField[H2OIINum  ][i] = TestProblemData.H2OII_Fraction * UniformDensity;
     BaryonField[H3OIINum  ][i] = TestProblemData.H3OII_Fraction * UniformDensity;
     BaryonField[CH3INum  ][i] = TestProblemData.CH3I_Fraction * UniformDensity;
     BaryonField[CH4INum  ][i] = TestProblemData.CH4I_Fraction * UniformDensity;
     BaryonField[CO2INum  ][i] = TestProblemData.CO2I_Fraction * UniformDensity;
