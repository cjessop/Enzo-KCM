...
extern "C" void FORTRAN_NAME(krome_driver)(
 ...
 float *H2I, float *OI, float *OHI, float *H2OI,
 float *O2I, float *CHI, float *COI, float *CI,
 float *CO2I, float *CH2I, float *CH3I, float *CH4I,
 float *HII, float *HeII, float *H2II, float *OII,
 float *OHII, float *H2OII, float *H3OII,
 float *O2II, float *CII, float *COII, float *HeIII,
...
int grid::SolveRateAndCoolEquations(int RTCoupledSolverIntermediateStep)
{
  ...
  int DensNum, GENum, TENum, Vel1Num, Vel2Num, Vel3Num, B1Num, B2Num, B3Num;
      int DeNum, HMNum, HINum, HeINum, H2INum, OINum,
...
//The same for KROME
 ...
 BaryonField[H2OINum], BaryonField[O2INum],
 BaryonField[CHINum], BaryonField[COINum],
 BaryonField[CINum], BaryonField[CO2INum],
 BaryonField[CH2INum], BaryonField[CH3INum],
 BaryonField[CH4INum], BaryonField[HIINum],
 BaryonField[HeIINum], BaryonField[H2IINum],
 BaryonField[OIINum], BaryonField[OHIINum],
 BaryonField[H2OIINum], BaryonField[H3OIINum],
 BaryonField[O2IINum], BaryonField[CIINum],
 BaryonField[COIINum], BaryonField[HeIIINum],
